...
| RF-1620 | Una sección **se mueve entera, con sus obras dentro**, que es el trabajo que si no son diez toques. En el PDF, su rótulo va en el pie de todas sus páginas: una hoja impresa que se separa del resto sigue diciendo de qué bloque es. |
