...
| RNF-108 | El diseño asume hasta unas 500 obras por fondo: del orden de 5000 tomas, con másters de **2-8 MB como mínimo** cada uno (10-40 GB en total). | **Revisado** con datos medidos (9.2). El sobre de 2-8 MB por toma no se cumple: los másters reales van de 0,2 a 19 MB. Las 500 obras por fondo siguen siendo una estimación sin comprobar; hoy hay 21 obras, 15 de ellas con fotografía, y 44 másters. |
