...
| RF-309, RF-606 · Bibliografía, Documento, Propietario | La ficha propia y la búsqueda dedicada de las otras tres. **Las tablas existen y las pantallas no.** Propietario y los vocabularios tienen pantalla de mantenimiento en «Tablas», que no es lo mismo que una ficha: no se llega a ella desde una obra ni tiene bloque de obras. Y un documento del archivo no tiene ninguna forma de corregir sus datos | Pendiente |
