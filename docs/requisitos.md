...
| Frontend: armar un dossier (RF-1600) | **Construido** el 11 de agosto de 2026: listado con buscador, alta, y la pantalla de armarlo —añadir obras, textos y biografía, moverlos de sitio, precios y notas—, con la puerta en «Tablas». La biografía y el currículum se escriben en la ficha del fondo. **Falta el generador del PDF**, y la pantalla lo dice en vez de pintar un botón muerto |
