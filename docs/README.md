...
| Saber cómo se construye y se despliega la aplicación | [`originales/diseno_interfaz_y_arquitectura_v4.md`](originales/diseno_interfaz_y_arquitectura_v4.md) |
...
razonamiento que las llevó hasta ahí, incluidas las marchas atrás.
