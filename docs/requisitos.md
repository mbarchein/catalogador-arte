...
| Frontend: armar un dossier y emitir su PDF (RF-1600) | **Construido** el 11 de agosto de 2026: listado con buscador, alta, la pantalla de armarlo —añadir obras, textos y biografía, moverlos de sitio, precios y notas— y el generador del PDF, con una obra por página, su portada y sus emisiones descargables. Puerta en «Tablas». Falta el recorrido con una obra real y mirar el papel |
